...
CanvasObject::CanvasObject(const glm::vec2& _topLeft, const float& _width, const float& _height)
{
    mTopLeft = _topLeft;
...
void CanvasObject::Draw(std::shared_ptr<ShaderProgram> _shader)
{
    if (!mVboID)
    {
...
void CanvasObject::SetFillColor(COLOR _fill)
{
    switch (_fill)
    {
    case RED:
...
void CanvasObject::SetImage(const std::string& _path)
{
    try
    {
